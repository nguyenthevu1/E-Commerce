...
export const loadUser = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(link + '/me');
...
export const updateProfile = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(link + `/me/update`, userData, config);
...
export const getAllUsers = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(link + '/admin/users');
...
export const getUserDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(link + `/admin/user/${id}`);
...
export const deleteUser = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(link + `/admin/user/${id}`);
